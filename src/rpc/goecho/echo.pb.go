...
func init() {
	proto.RegisterType((*Msg)(nil), "goecho.Msg")
}
...
var fileDescriptor_08134aea513e0001 = []byte{
	...
	0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x4b, 0xcf, 0x07, 0xf1, 0x94, 0x34, 0xb9, 0x98,
	0x7d, 0x8b, 0xd3, 0x85, 0xf8, 0xb8, 0x98, 0x32, 0x53, 0x24, 0x18, 0x15, 0x18, 0x35, 0x58, 0x83,
	0x98, 0x32, 0x53, 0x84, 0x84, 0xb8, 0x58, 0x4a, 0x52, 0x2b, 0x4a, 0x24, 0x98, 0x14, 0x18, 0x35,
	0x38, 0x83, 0xc0, 0x6c, 0x23, 0x75, 0x2e, 0x16, 0xd7, 0xe4, 0x8c, 0x7c, 0x21, 0x79, 0x2e, 0xe6,
	0xe2, 0xc4, 0x4a, 0x21, 0x6e, 0x3d, 0x88, 0x11, 0x7a, 0xbe, 0xc5, 0xe9, 0x52, 0xc8, 0x9c, 0x24,
	0x36, 0xb0, 0x15, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x72, 0x5f, 0xe1, 0x09, 0x70, 0x00,
	0x00, 0x00,
}
...
func (c *echoClient) Say(ctx context.Context, in *Msg, opts ...grpc.CallOption) (*Msg, error) {
	out := new(Msg)
	err := c.cc.Invoke(ctx, "/goecho.Echo/say", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
