...
这里收集了一些常用的[ZshGlobalAliase 全局别名]:
```
alias -g ...='../..'
alias -g ....='../../..'
alias -g .....='../../../..'
...
```
 ...
 - [主页]( http://www.zsh.org/)
 - [源代码](http://sourceforge.net/projects/zsh/)
 - [Z shell page at sunsite.dk]( http://zsh.sunsite.dk/)
 - [From Bash to Z Shell: Conquering the Command Line](http://www.bash2zsh.com/)
 - [Mailing list archive](http://www.zsh.org/mla/)
 - [ZshFAQ](http://zsh.dotsrc.org/FAQ/)
 - [用户手册](http://zsh.sunsite.dk/Guide/)
...
# zmv ==
zmv是[wiki:Zsh]的一个AutoLoadFunction, 用Zsh脚本写成,用来给文件/目录批量改名
```
#!sh
# 批量给文件添加前缀
$ autoload -Uz zmv
...
# 给所有文件添加前缀ext_, 1.txt变成ext_1.txt, 以此类推
$ zmv '(*)' 'ext_$1'
$ ls
ext_1.txt  ext_2.txt  ext_3.txt  ext_4.txt  ext_5.txt
```
