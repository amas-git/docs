---
layout: 'eth_#'
title: amas-bookmarks
date: 2018-07-19 12:01:08
tags:
---
 ...
 * http://www.povray.org/
# 统计/数据可视化
 * http://www.r-project.org/ (统计绘图)
 * http://www.gnuplot.info/
 * http://inkscape.org/index.php?lang=en (图像编辑)
 * http://asymptote.sourceforge.net/
 * http://colorschemedesigner.com/ (配色)
 * * http://www.graphviz.org/
# 演示文档
 * http://linuxtoy.org/archives/pinpoint.html (LT上的讨论帖子)
 * http://impressive.sourceforge.net/ (演示工具)
 ...
 * Figlet(将文字转化为AscII图形): http://www.figlet.org/
# 绘画教程 
 * http://www.artgraphica.net/
 * http://www.artyfactory.com/
# 代码审查
 * http://gerrit-documentation.googlecode.com/ (+git)
# 设计
 * http://www.stumbleupon.com/
 * http://www.free-clip-art.com/
 * http://www.deviantart.com/
 ...
 * http://icon.io/
 * http://worldui.com/a/ui_designer/ui_designer_1/list_17_1.html
 * http://dryicons.com/
 ...
 * http://ddgoodi.es
 * http://www.mikaeleidenberg.se/
 * http://www.cazoobi.com/
 * http://designmoo.com
 * http://dribbble.com/ 
 * http://mobilegui.net/inspiration/
 * http://mobiledesign.com/
 * http://gesturecons.com/ (手势)
 * http://medialoot.com/browse/
 * 
# 平面设计师 & 摄影师
 * http://work.bauldoff.com/
 * http://www.brendanaustin.com/
 * http://butdoesitfloat.com/
 * http://victortimofeev.com/ 
 * http://cargocollective.com/
 * http://cargocollective.com/secretcavern
 * http://cargocollective.com/learnsomethingeveryday
 * http://cargocollective.com/Nicetomeetyou
 * http://cargocollective.com/nieder
 * http://www.abstract-codex.net/
 * http://www.luizrisi.com/
 * http://www.maurogatti.com/
 * http://victortimofeev.com/
 * http://www.stefanglerum.com/
 * http://www.malikafavre.com/ 
 * http://www.ambushstudio.com/
 * http://www.complexitygraphics.com/
 * http://www.flickr.com/photos/lwdemery/ (1983)
# 字体
 * http://www.dafont.com/
# 下载工具
 * [wiki:Axel] : http://axel.alioth.debian.org/
# 通讯工具
 * CenterIm: http://www.centerim.org/
 * Irris: http://www.irssi.org/
# 创意
 ...
 * GnuPG
# 搜索
 * [http://betterthangrep.com/ Ack] (Better than grep)
# 影音 
 ...
 * http://sqliteman.com/
# 编辑工具 ==
 * Charm(博客客户端) http://ljcharm.sourceforge.net/
 * DeHTML(去除HTML) http://www.moria.de/~michael/dehtml/
# Code Transformation  ==
 ...
 * 性能监控: http://munin-monitoring.org/
 * Trace Route 2.0: mtr
 * 端口扫描/协议分析: nmap
 * Web载入测试工具: siege & tsung
# 软件市场
 * http://www.giveawayoftheday.com/ (每天一款免费软件)
# 电子书
 ...
 * [http://link.springer.com/ Springer出版物在线检索]
# 数学
 * http://www.coolmath.com/
# 科普
 * http://www.extremescience.net/
 * http://missbakersbiologyclass.com/blog/ (生物)
 * http://www.ted.com/ (值得传播的思想)
# 图书馆
 * http://www.nypl.org/collections (可以搜到很多图片)
 * http://www.gutenberg.org/wiki/Main_Page  (免费图书)
 * http://www.questia.com/
# 博物馆
 * http://www.metmuseum.org/
# 字典
 * http://dictionary.reference.com/ (除了辞典功能,还可以测试你认识多少单词)
 * http://www.thefreedictionary.com/
# 搜索引擎
 * http://www.wolframalpha.com
# 其他
 * http://www.rainymood.com/ (雨天模拟)
 * http://www.commandlinefu.com/commands/browse (指令分享)
 * 找公园: http://www.ohranger.com/
 * 钱币: http://www.money.org
 * DIY : http://www.diynetwork.com/
# 技术博客
 * http://luisartola.com/software/
 * http://www.cs.bham.ac.uk/~mhe/ (`函数式编程`)
# 我爱CLI
 * http://onethingwell.org/
# Comics
 * http://www.michaelhacker.at/
 * http://www.phonelosers.org/comics
