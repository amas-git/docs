...
- 落实好OKR, 配合上级指定好自己部门的OKR, 协助下级指定好各自的OKR
- 将客户端的各种信息文档集中到一起, 可以使其他部门很方便的查阅
  1. 建议公司建立一个统一的门户用于大家发布消息, 保存工作文档, 现有的文档,规范, 会议纪要, 公司活动进展等信息. 太过于分散, 有些在gdoc上有些在邮件里,有些在wiki上, 不仅技术组的同事之间没法知道彼此的工作, 而且你想查阅其他部门的文档资料是很不方便的.

- 制定技术人员的成长路线, 一个Q要掌握的技能, 以每人每月一篇与自己成长路线相关的技术文章
